...
const KELAS = "1 SD";
const MAPEL = "Pendidikan Jasmani, Olahraga, dan Kesehatan";
...
function cetakNaskahResmi() {
  const npx = spawnSync(
    ...
    [
      ...
      "--tsconfig",
      "tsconfig.json",
      "scripts/cetak-naskah-pjok-1-bab1-4.ts",
    ],
    {
      cwd: akar,
      encoding: "utf8",
...
for (const item of daftar) {
  ...
  const alias = [
    KUNCI,
    `${rapikanKunci(KELAS)}|pendidikan jasmani, olahraga, dan kesehatan|${rapikanKunci(MATERI)}|${VERSI}`,
  ];
