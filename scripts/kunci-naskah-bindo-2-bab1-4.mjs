...
function judulAlias(materi) {
  const tambahan = [];
  if (/berhati-hati di jalan/i.test(materi)) {
    tambahan.push("Bab 3: Berhati-hati di Mana Saja");
  }
  if (/keluargaku kreatif/i.test(materi)) {
    tambahan.push("Bab 4: Keluargaku Unik");
  }
  return tambahan;
}
...
function cetakNaskahResmi() {
  const npx = spawnSync(
    ...
    [
      ...
      "--tsconfig",
      "tsconfig.json",
      "scripts/cetak-naskah-bindo-2-bab1-4.ts",
    ],
    {
      cwd: akar,
      encoding: "utf8",
