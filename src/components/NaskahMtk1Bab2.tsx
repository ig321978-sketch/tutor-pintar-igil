...
function KuisJumlahkan({
  ...
  const [a, setA] = useState(sudah ? aBenar : "");
  const [b, setB] = useState(sudah ? bBenar : "");
  const [c, setC] = useState(sudah ? cBenar : "");
